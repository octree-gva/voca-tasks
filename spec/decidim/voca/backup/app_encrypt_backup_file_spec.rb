...
describe "Voca::AppEncryptBackupFile" do
  ...
  context "#encrypt_backup_file" do
    ...
    it "when inicialize class" do
      backup_file_encrypter = class_double("Decidim::Voca::AppEncryptBackupFile")
    ...
    it "when encrypts backup_file, get_cipher and encrypt_backup_file" do
      backup_file_encrypter = Decidim::Voca::AppEncryptBackupFile.new(backup_file_path)
