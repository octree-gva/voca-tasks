...
describe "Voca::AppDecryptBackupFile" do
  ...
  context "#decrypt_backup_file" do
    ...
    it "when inicialize class" do
      backup_file_decrypter = class_double("Decidim::Voca::AppDecryptBackupFile")
    ...
    it "when decrypts backup_file_enc, decipher! and decrypt!" do
      backup_file_decrypter = Decidim::Voca::AppDecryptBackupFile.new(backup_file_enc_path)
