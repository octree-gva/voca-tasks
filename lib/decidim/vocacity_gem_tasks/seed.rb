    ...
    private
      def validate_options!
        [
          ...
          raise Decidim::VocacityGemTasks::Error.new("missing option #{k}") unless options.key?(k)
          raise Decidim::VocacityGemTasks::Error.new("option #{k} is empty") if options[k].blank?
        end
      end
